            ...
            <tbody>
                <?php while( $data = mysqli_fetch_assoc($result)) { ?>
                    <tr class="text-xs font-weight-bold">
                        ...
                        <td class="align-middle text-left"><?php echo $data['kelas'];?></td>
                        <td class="align-middle text-left"><?php echo $data['absen'];?></td>
                        <td class="align-middle text-left"><img src="file/<?php echo $data['foto'];?>" width="100" height="100"/></td>
                        <td>
                            <button class="edit"><a href="edit-siswa.php?id=<?php echo $data['id'];?>" >EDIT</a></button>
                            <button class="delete"><a href="delete-siswa.post.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are you sure to delete the data from <?php echo $data['nama'] . '?';?>')">DELETE</a></button>
